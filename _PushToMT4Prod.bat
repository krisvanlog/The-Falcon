...
set DEST_DIR1="C:\Program Files (x86)\MetaTrader - AxiTrader - Term1\MQL4\Experts\01_The-Falcon"
set DEST_DIR2="C:\Program Files (x86)\MetaTrader - AxiTrader - Term2\MQL4\Experts\02_The-Falcon"
set DEST_DIR3="C:\Program Files (x86)\MetaTrader - AxiTrader - Term3\MQL4\Experts\03_The-Falcon"
set DEST_DIR4="C:\Program Files (x86)\MetaTrader - AxiTrader - Term4\MQL4\Experts\04_The-Falcon"
